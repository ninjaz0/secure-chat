...
1. 打开最新版 Release 页面。
2. 下载 `SecureChatMac-版本号.dmg`，例如 `SecureChatMac-0.2.7.dmg`。
3. 双击打开 DMG。
...
1. 打开最新版 Release 页面。
2. 下载 `SecureChatAndroid-版本号.apk`，例如 `SecureChatAndroid-0.2.7.apk`。
3. 在手机上打开下载完成的 APK。
...
2. 如果该 Release 提供 Windows 包，下载 `SecureChatWindows-版本号.msix`，例如
   `SecureChatWindows-0.2.7.msix`。如果页面没有 Windows 包，说明该版本还没有在
